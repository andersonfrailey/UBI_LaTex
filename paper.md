...
\newcommand{\ospc}{\footnote{Authorís calculations using OSPC Tax-Calculator.}}
...
\includegraphics[scale=0.750]{a1}
\end{center}
%\floatfoot{A note}
\end{figure}
...
\includegraphics[scale=0.750]{a2}
%\floatfoot{A note}
\end{figure}
...
With the repeal of the aforementioned tax provisions, roughly $92\%$ of tax units will face a tax increase resulting in $\$708$ billion in new liabilities, nearly half of that falling on the top twenty percent of earners.\footnote{Authorís calculations using OSPC Tax-Calculator.}
...
\bibitem{bib02} Office of Management and Budget, \textit{Table 3.2óOutlays by Function and Subfunction: 1962ñ2021}.\\ \texttt{https://obamawhitehouse.archives.gov/omb/budget/Historicals}

\bibitem{bib03} Office of Management and Budget, \textit{Table 11.3óOutlays for Payments for Individuals by Category and Major Program: 1940ñ2021}.\\ \texttt{https://obamawhitehouse.archives.gov/omb/budget/Historicals}
...
\bibitem{bib06} Angrist, Joshua D, ìThe Effect of Veterans Benefits on Education and Earnings.î \textit{ILR Review}. Vol. 46, No. 4 (Jul., 1993), pp. 637-652.\\ \texttt{http://www.jstor.org/stable/2524309}
...
OSPCís Tax-Calculator is an open source microsimulation tax model that can be used to simulate changes to federal tax policy to conduct revenue scoring, distributional impact, and, as seen in this paper, the implementation of a universal basic income. The model is continually being updated as contributions are made, so the results from the calculations seen in this paper may change as improvements are merged in.
